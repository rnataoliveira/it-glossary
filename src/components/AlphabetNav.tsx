      ...
      {ALPHABET.map((letter) => {
        ...
        return (
          <button
            ...
            className={`w-8 h-8 rounded text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1
              ${active
